...
import { isAst, isPlainObject, isFunction, isBoolean, isNumber } from '../../utils/typeUtils'
...
function parseAstItem(arg, opts) {
  return [new opts.NodeClass(parseAst(arg), null, null, opts.bool, opts.not)]
}
